...
export class ToolsService {
     ...
     * 實體分群
     */
    public static entityGroupTool<ThrowOnError extends boolean = true>(options: Options<ToolsEntityGroupToolData, ThrowOnError>) {
        return (options.client ?? client).post<ToolsEntityGroupToolResponses, ToolsEntityGroupToolErrors, ThrowOnError>({
            responseType: 'json',
